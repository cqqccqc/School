          ...
          <tr>
            ...
            <td>
              <form id="spwd" method="post" action="<?=base_url().'index.php/user/edit_spwd'?>">
                <input type="password" class="form-control" placeholder="原登陆密码" name="ospwd"><input type="password"  class="form-control" placeholder="新密码" name="nspwd">
                <input type="password"  class="form-control" placeholder="确认密码" name="cspwd"><input type="submit" class="btn btn-warning">
              </form>
            </td>
          ...
          <tr>
            ...
            <td>
              <form id="tpwd" method="post" action="<?=base_url().'index.php/user/edit_tpwd'?>">
                <input type="password"  class="form-control" placeholder="原交易密码" name="otpwd"><input  type="password" class="form-control" placeholder="新密码" name="ntpwd">
                <input type="password"  class="form-control" placeholder="确认密码" name="ctpwd"><input type="submit" class="btn btn-warning">
              </form>
            </td>
